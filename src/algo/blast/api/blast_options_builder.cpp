/*  $Id: blast_options_builder.cpp 151315 2009-02-03 18:13:26Z camacho $
* ===========================================================================
*
                   ...
                   objects::CBlast4_parameter & p)
{
    ...
    case 'D':
        ...
        } else if (B4Param_DbFilteringAlgorithmIds.Match(p)) {
            m_DbFilteringAlgorithmIds = v.GetInteger_list();
        } else {
            found = false;
        }
        break;
