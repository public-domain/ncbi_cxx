/*  $Id: blasthits_unit_test.cpp 148871 2009-01-05 16:51:12Z camacho $
* ===========================================================================
*
...
* ===========================================================================
*
* $Log: blasthits-cppunit.cpp,v $
* Revision 1.66  2008/04/07 16:41:59  madden
* Increase hitlist size for comp-based stats
*
* Revision 1.65  2008/01/31 22:07:00  madden
* Change call to LookupTableWrapInit as part of fix for SB-44
*
* Revision 1.64  2007/11/08 17:09:08  camacho
* Bring up to date with changes in SVN revision 113729
*
* Revision 1.63  2007/10/22 19:16:09  madden
* BlastExtensionOptionsNew has Boolean gapped arg
*
* Revision 1.62  2007/05/22 20:37:53  papadopo
* remove decline-alignment penalty
*
* Revision 1.61  2007/03/12 17:55:34  camacho
* Introduced query splitting
*
* Revision 1.9  2007/02/08 22:30:32  papadopo
* update function signature
*
* Revision 1.8  2007/02/08 22:22:42  papadopo
* sync with production
*
* Revision 1.60  2007/02/08 17:15:21  papadopo
* remove tests that assume HSPs have traceback when they are merged
*
* Revision 1.59  2006/11/09 16:26:15  avagyanv
* fixed a minor syntax problem with assert_equals
*
* Revision 1.58  2006/11/03 15:30:36  papadopo
* test fix for hit-merging bug
*
* Revision 1.57  2006/09/15 13:12:04  madden
* Change to LookupTableWrapInit prototype
*
* Revision 1.56  2006/09/01 15:06:50  papadopo
* change initialization to reflect per-context cutoffs
*
* Revision 1.55  2006/06/29 16:25:24  camacho
* Changed BlastHitSavingOptionsNew signature
*
* Revision 1.54  2006/06/06 15:14:31  madden
* Add testHitListUpdate to test Blast_HitListUpdate, especially with a large input
*
* Revision 1.53  2006/06/05 13:34:05  madden
* Changes to remove [GS]etMatrixPath and use callback instead
*
* Revision 1.52  2006/04/20 19:37:19  madden
* Mark sequences as invalid at setup
*
* Revision 1.51  2006/02/23 18:31:51  madden
* Prototype change to Blast_HSPListsMerge
*
* Revision 1.50  2006/02/15 15:09:26  madden
* Changes for GapEditScript structure change
*
* Revision 1.49  2006/02/07 14:25:33  madden
* Add testBlastMergeTwoHSP as test of BlastMergeTwoHSPs in blast_hits.c
*
* Revision 1.48  2006/01/30 17:42:25  bealer
* - Add BOOST_REQUIRE to check for fatal errors ahead of time, and use
*   same in place of BOOST_REQUIRE() in others.
*
* Revision 1.47  2006/01/12 20:42:51  camacho
* Fix calls to BLAST_MainSetUp to include Blast_Message argument, use BlastQueryInfoNew
*
* Revision 1.46  2005/09/27 14:46:34  madden
* Change args to Blast_HSPListAdjustOddBlastnScores
*
* Revision 1.45  2005/08/15 16:14:28  dondosha
* Added test for adjustment of odd blastn scores
*
...
*
* Revision 1.43  2005/05/19 16:20:09  madden
* Adjustment for BLOSUM62, protection against NULL HSP
*
* Revision 1.42  2005/05/16 12:28:41  madden
* Tests for new SBlastHitsParametersNew function
*
* Revision 1.41  2005/05/03 16:00:07  dondosha
* Check that purge is skipped in Blast_HSPListPurgeHSPsWithCommonEndpoints for PHI BLAST
*
* Revision 1.40  2005/05/02 13:09:02  madden
* In testCheckHSPCommonEndpoints use Blast_HSPListNew and test Blast_HSPListPurgeHSPsWithCommonEndpoints rather than Blast_CheckHSPsForCommonEndpoints
*
* Revision 1.39  2005/04/27 20:08:40  dondosha
* PHI-blast boolean argument has been removed from BlastSetup_ScoreBlkInit
*
* Revision 1.38  2005/04/12 20:41:12  dondosha
* Removed unused parameter from call to ungapped reevaluation with ambiguities
*
* Revision 1.37  2005/04/11 14:05:12  dondosha
* Added tests of Blast_HSPTestIdentityAndLength function
*
* Revision 1.36  2005/04/06 21:26:37  dondosha
* GapEditBlock structure and redundant fields in BlastHSP have been removed
*
* Revision 1.35  2005/03/04 17:20:44  bealer
* - Command line option support.
*
* Revision 1.34  2005/03/02 18:49:47  dondosha
* Added test for reevaluation with ambiguities, when hit never gets score above 0
*
* Revision 1.33  2005/01/24 15:25:38  dondosha
* Changed reevaluation with ambiguities tests due to correction to choose best scoring part of alignment
*
* Revision 1.32  2005/01/19 19:07:17  coulouri
* do not cast pointers to smaller integer types
*
* Revision 1.31  2005/01/18 14:55:05  camacho
* Changes for taking new tie-breakers for score comparison into account
*
* Revision 1.30  2005/01/11 15:32:09  dondosha
* Removed unused argument from 2 reevaluation with ambiguities functions
*
* Revision 1.29  2005/01/10 14:03:24  madden
* Prototype change to BlastInitialWordParametersNew
*
* Revision 1.28  2005/01/03 15:55:09  dondosha
* Added test for Blast_CheckHSPsForCommonEndpoints function
*
* Revision 1.27  2004/12/14 21:16:31  dondosha
* Query frame argument added to Blast_HSPInit; renamed all constants according to toolkit convention
*
* Revision 1.26  2004/12/09 15:26:30  dondosha
* BlastSetup_GetScoreBlock renamed to BlastSetup_ScoreBlkInit; all constants renamed according to toolkit convention
*
* Revision 1.25  2004/12/02 16:44:55  bealer
* - Change multiple-arrays to array-of-struct in BlastQueryInfo
*
* Revision 1.24  2004/11/18 21:37:22  dondosha
* Added test for reevaluation with ambiguities for a translated search; moved testHSPReset to traceback-cppunit under different name
*
* Revision 1.23  2004/11/04 18:42:54  dondosha
* Added test for reevaluation with ambiguities for ungapped blastn
*
* Revision 1.22  2004/11/02 14:33:20  madden
* Adjust testOrderingOfFullHSPList for fix in blast_hits.c
*
* Revision 1.21  2004/11/01 19:21:29  dondosha
* Enabled testOrderingOfFullHSPList, as a fix has been made to make it work
*
* Revision 1.20  2004/11/01 18:48:04  madden
* Comment out call to testOrderingOfFullHSPList, test awaits further code changes
*
* Revision 1.19  2004/11/01 18:39:50  madden
* Test for fix from Mike Gertz, check that CalculateLinkHSPCutoffs is reset before use.
*
* Revision 1.18  2004/10/25 20:28:04  dondosha
* Pass BlastHitSavingParameters to the ReevaluateWithAmbiguities functions
*
* Revision 1.17  2004/10/19 16:37:52  dondosha
* Added test for saving HSPs after reaching the HSP limit
*
* Revision 1.16  2004/10/04 18:04:07  dondosha
* Changed the sorting tests to use new functions for sorting by score and by e-value
*
* Revision 1.15  2004/09/21 13:55:13  dondosha
* Added test for the Blast_HSPListCheckIfSorted function
*
* Revision 1.14  2004/07/07 20:03:29  dondosha
* Removed unused variables
*
* Revision 1.13  2004/07/07 19:51:45  camacho
* + testHSPInitWithNulls
*
* Revision 1.12  2004/07/06 15:58:45  dondosha
...
*
* Revision 1.10  2004/05/19 15:28:30  dondosha
* Edit script operations changed from macros to an enum
*
* Revision 1.9  2004/05/07 15:42:40  papadopo
* fill in and use BlastScoringParameters instead of BlastScoringOptions
*
* Revision 1.8  2004/05/05 15:29:39  dondosha
* Renamed functions in blast_hits.h accordance with new convention Blast_[StructName][Task]
*
* Revision 1.7  2004/04/21 20:21:35  madden
* Tests for HSPInit and HSPReset
*
* Revision 1.6  2004/04/21 19:31:58  madden
* Tests for Blast_HSPListPurgeNullHSPs
*
* Revision 1.5  2004/04/21 18:07:42  madden
* Removed code for defunct DeletedHSPInMergeHSPLists test
*
* Revision 1.4  2004/04/21 17:34:14  madden
* Use cleaned up API for saving HSPs, HSPLists, HitLists
*
* Revision 1.3  2004/04/02 18:31:06  dondosha
* Disabled DeletedHSPInMergeHSPLists; probably it will soon be deleted altogether
*
* Revision 1.2  2004/04/02 16:10:43  dondosha
* Moved DeletedHSPInMergeHSPLists test from bl2seq-cppunit to blasthits-cppunit
*
* Revision 1.1  2004/04/01 23:11:11  dondosha
* Test(s) for hit saving procedures: one test for MergeHSPLists created
*
*
* ===========================================================================
*/
