/* $Id: Seq_id.cpp 165161 2009-07-07 18:37:19Z ucko $
 * ===========================================================================
 *
...
static const char * kBuiltInGuide[] = {
    ...
    "3+5  F??  ddbj_tpa_prot",
    "3+5  G??  ddbj_wgs_prot",
    "3+5  H??  gb_tpa_prot # fallback definition for older clients",
    ...
    "4+9   C???  embl_wgs_nuc",
    "4+10  C???  embl_wgs_nuc",
    "4+8   D???  gb_tpa_nuc # fallback definitions",
    "4+9   D???  gb_tpa_nuc",
    "4+10  D???  gb_tpa_nuc",
    ...
    "2+6  AI  gb_est",
    "2+6  AJ  embl_dirsub",
    "2+6  AK  ddbj_other_nuc # fallback",
    "2+6  AK  ddbj_mrna",
    "2+6  AL  embl_other_nuc # nominally for genome projects, but unrestricted",
    "2+6  AM  embl_dirsub",
    "2+6  AN  embl_con",
    ...
    "2+6  CP  gb_genome",
    "2+6  CQ  embl_patent",
    "2+6  CR  embl_other_nuc",
    "2+6  CS  embl_patent",
    "2+6  CT  embl_other_nuc",
    "2+6  CU  embl_other_nuc",
    "2+6  CV  gb_est",
    "2+6  CW  gb_gss",
    "2+6  CX  gb_est",
    "2+6  CY  gb_genome",
    ...
    "2+6  GJ  gb_tpa_nuc # fallback",
    "2+6  GJ  gb_tpa_con",
    "2+6  GK  gb_tpa_nuc # fallback",
    ...
    "#special CAZ66766-CZZ99999  unreserved_prot"
};
/*
