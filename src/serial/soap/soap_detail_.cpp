/* $Id: soap_detail_.cpp 103491 2007-05-04 17:18:18Z kazimird $
 * ===========================================================================
 *
...
void CSoapDetail_Base::ResetAnyContent(void)
{
    m_AnyContent.clear();
    m_set_State[0] &= ~0x3;
}

void CSoapDetail_Base::Reset(void)
{
    ResetAnyContent();
}

BEGIN_NAMED_BASE_CLASS_INFO("detail", CSoapDetail)
{
...
// constructor
CSoapDetail_Base::CSoapDetail_Base(void)
{
